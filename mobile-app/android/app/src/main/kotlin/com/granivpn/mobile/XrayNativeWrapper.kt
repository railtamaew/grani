...
class XrayNativeWrapper(private val context: Context) {
    ...
    private fun logIpRouteDiagnostic() {
        // Diagnostics must never serialize transport startup. Process creation
        // and reading both pipes took more than a second on the emulator and
        // can be slower on devices under storage pressure.
        Thread({
            try {
