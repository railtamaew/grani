...
class DeviceRepository(BaseRepository[Device]):
    ...
    def count_distinct_device_ids_by_user_id(self, user_id: int) -> int:
        """Логические устройства (уникальные строковые device_id)."""
        n = (
    ...
    def count_active(self) -> int:
        """Подсчитать количество активных устройств"""
        return self.db.query(Device).filter(Device.is_active == True).count()
